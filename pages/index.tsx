...
export default function Home(props: {
  ...
  const [members, setMembersnav] = useState<TeamMember[]>([]);
  ...
  useEffect(() => {
    ...
    setMembersnav(props.fetchedMembers.sort((a, b) => (a.rank > b.rank ? 1 : -1)));
    setLoading(false);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="HackaBull" /> {/* !change */}
      ...
      {/* Hero section */}
      <section className=" min-h-screen p-4 bg-contain header">
        <div
          style={{ minHeight: 480 }}
        ...
        >
          ...
          >
            ...
            <p className="text-center my-4 md:font-bold md:text-3xl text-xl">
              {' '}
              {/* !change */}Tampa’s Largest Hackathon for Students
            </p>
          </div>
      ...
      {/* Video Space */}
      <section className="z-0 relative md:h-[560px] py-[3rem] bg-red video-space">
        <div className="flex flex-col justify-center items-center md:flex-row">
          {/* Video */}
          {/* !change */}
          <iframe width="560" height="315" src="https://www.youtube.com/embed/LjnZkeWtti4" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
          {/* Stats */}
          <div className="">
      ...
      <section className="md:p-12 p-6">
        ...
        <div className="md:text-base text-sm">
          HackaBull is the biggest hackathon in Tampa for students! <br />
        ...
        <section>
          <div className="flex flex-col flex-grow bg-white">
            ...
            <h2 className="my-2 text-center">
              ...
              <a
                href="mailto:sponsors@hackabull.io                "
                rel="noopener noreferrer"
                target="_blank"
                className="underline"
              >
                sponsors@hackabull.io
              </a>
            </h2>
          </div>
        </section>
